...
1. **Marketing Board „initialisieren" schlägt fehl** → `KANBAN_MARKETING_BOARD_MISSING`
   ...
   *Fix-Richtung:* „initialisieren" muss das Board real seeden ODER die Precondition ehrlich zeigen
...
3. **Dispatch-Gate-Sicht: nicht vorhanden / funktioniert nicht.** Nur i18n-Strings da, keine echte
   Ansicht. *Fix-Richtung:* die Dispatch-Gate-Ansicht bauen/verdrahten (NL-5-Preflight sichtbar
