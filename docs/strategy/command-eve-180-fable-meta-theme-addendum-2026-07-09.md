...
│ update) │ │
├───────────────────┼─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│ Update truth │ components/settings/UpdateModal.tsx (status machine at line 17; stays the detail surface), common/update/updateTypes.ts, ipcBridge.autoUpdate._ / │
│ (read-only reuse) │ ipcBridge.update._ (unchanged), Layout mount + aionui-open-update-modal event (Layout.tsx:209–215, 396–398) │
├───────────────────┼─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
...
│ rebuild │ AppearanceSettings/CssThemeSettings.tsx + CssThemeModal.tsx (gated to advanced), AppearanceSettings/presets/_ + presets.ts + themeCovers.ts (retired │
...
├───────────────────┼─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│ Route sweep │ every page under pages/ per §3; styles/arco-override.css (Arco --color-_ aliases are the inheritance rail); components/base/AionModal (dialog tier) │
└───────────────────┴─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
Enforcement: a lint-style gate in 1.8.0-f — no new hex/rgb literals in packages/desktop/src/renderer outside styles/themes/_ and styles/colors.ts, and no visible --aou-_ purple
...
- builtinThemes.ts prunes the four decorative presets from public builds; the unused presets/_.css (incl. hello-kitty, misaka-mikoto, retroma-_ variants never registered) and
