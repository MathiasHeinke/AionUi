...
export const EVE_STRATEGY_SKILL_IDS = [
  ...
  'option-tournament',
  'landing-copy',
  // premium-website-builder: complete website production from a brand, visual
  // source or rough idea. The real skill owns art direction, implementation,
  // poster-first lazy cinematic media, responsive behavior and browser QA.
...
export const DEFAULT_COMMAND_EVE_CAPABILITY_PACK: CommandEveCapabilityPack = {
  ...
  skills: [
    ...
    },
    {
      ...
      tier: 'department',
      source: 'Command EVE website production skill',
      default_state: 'active',
    },
    {
      id: 'local-vision-qa',
...
function writeCommandEveManagedSkills(
  ...
  // separate id-space from the onboarding capability ids, but 7 operator skills
  // (content-machine, video-first-content-engine, blog-publishing-lane, local-kanban-ledger,
  // voice-first-run, crm-department, premium-website-builder) INTENTIONALLY overlap: their capability entry is now
