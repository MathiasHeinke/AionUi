...
export const useResizableSplit = (options: UseResizableSplitOptions = {}) => {
  ...
  const renderHandle = ({
    ...
    >
      <span
        className={classNames(
          'pointer-events-none block h-full w-2px bg-bg-3 opacity-90 rd-full transition-all duration-400 group-hover:w-6px group-hover:bg-aou-6 group-active:w-6px group-active:bg-aou-6',
          lineClassName
        )}
        style={lineStyle}
      />
