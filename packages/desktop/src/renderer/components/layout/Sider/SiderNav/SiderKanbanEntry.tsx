...
const SiderKanbanEntry: React.FC<SiderKanbanEntryProps> = ({ isMobile, isActive, collapsed, siderTooltipProps, onClick }) => {
    ...
    <Tooltip {...siderTooltipProps} content={label} position='right'>
      ...
      >
        <span className='size-22px flex items-center justify-center shrink-0 text-t-primary'>
          <ViewGridCard theme='outline' size='16' fill='currentColor' className='block leading-none' style={{ lineHeight: 0 }} />
        </span>
