...
import { DeleteOne, EditOne, Peoples, Plus, Pushpin, Right } from '@renderer/components/icons';
  ...
  return (
    <>
      {collapsed ? (
                ...
                <Tooltip key={team.id} {...siderTooltipProps} content={team.name} position='right'>
                  <button
                    ...
                    className={classNames(
                      'relative w-full h-40px border-none bg-transparent flex items-center justify-center cursor-pointer transition-colors rd-8px',
        ...
        <div className='shrink-0 flex flex-col gap-2px'>
          <div
            className='group/label sider-section-label flex items-center h-28px select-none sticky top-0 z-10 mt-8px'
          ...
          >
            ...
            <Tooltip content={t('team.sider.createTeam')} position='top'>
              <button
                ...
                className='mr-6px size-20px p-0 border-none bg-transparent rd-4px flex items-center justify-center hover:bg-fill-4 transition-all shrink-0 cursor-pointer text-t-secondary hover:text-t-primary'
