          ...
          <ArcoLayout className={'size-full layout flex-1 min-h-0'}>
            ...
            >
              <ArcoLayout.Header
                ...
                onClick={onClick}
                data-testid='layout-sider-header'
              >
                {/* Brand wordmark/logo intentionally removed from the in-app sidebar:
                    the EVE brand lives only in the macOS window title bar now. The
                    header is kept as a hidden devtools-gesture target (onClick) and
                    to host the mobile collapse control below. */}
                {isMobile && !collapsed && (
                  <button
                    type='button'
