...
test.describe('Skills Hub - Boards Rendering (P1)', () => {
  ...
  upstreamSkillsHubTest('TC-S-27: should render Extension Skills board with correct structure', async ({ page }) => {
  ...
  upstreamSkillsHubTest(
    'TC-S-28: should render Auto-injected Skills board with correct structure',
    async ({ page }) => {
      // Screenshot 01: Initial state
