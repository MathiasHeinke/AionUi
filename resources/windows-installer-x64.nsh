...
Function .onVerifyInstDir
  ...
  ${IfNot} ${RunningX64}
    MessageBox MB_OK|MB_ICONSTOP \
      ...
      This Command EVE installer is designed for x64 architecture.$\n$\n\
      Your system is 32-bit architecture. Command EVE currently supports Windows x64 only."
    Quit
  ${EndIf}
  ...
  ${If} ${IsNativeARM64}
    MessageBox MB_OK|MB_ICONSTOP \
      "Installation package architecture mismatch$\n$\n\
      This Command EVE installer is designed for x64 architecture.$\n$\n\
      Your system is ARM64 architecture. Command EVE currently supports Windows x64 only."
    Quit
  ${EndIf}
FunctionEnd
