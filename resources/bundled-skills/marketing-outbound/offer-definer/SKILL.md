...
Verdichtet ein Angebot + Preis zu **einem** Satz, der hält: was der Kunde danach hat (Outcome), warum
er es dir glaubt (Proof), warum er nichts riskiert (Risk-Reversal) und was er als Nächstes tut (CTA).
...
4. **CTA = ein kleiner Schritt.** Nicht „kauf", sondern der nächste niedrigschwellige Schritt:
   Analyse-Call, kurzer Blick, Probe-Woche. Muss zum Preis passen (250 €/mo → Demo; 5.000 € → Audit-Call).
5. **Auf einen Satz verdichten.** Formel unten. Ein Outcome, ein Proof-Anker, eine Risk-Umkehr.
   Streiche jedes „und auch noch". Mehr als ein Versprechen = kein Offer, ein Katalog.
6. **Preis verorten — nicht verstecken.** Ankere den Preis am Outcome, nicht an deiner Zeit:
   „250 €/mo" neben „ein gewonnener Kunde zahlt das 10×". Preis ist Teil des Offers, kein Nachgedanke.
7. **Self-Check:** Würde der Kunde diesen Satz selbst nachsprechen? Steht der Nutzen vor dem Wie?
...
## Bausteine
- Outcome:        <was der Kunde danach hat — Zahl/Zeit, nicht Feature>
- Proof:          <Kunde+Zahl / Zahl / Mechanismus> (ANNAHME falls unbelegt)
- Risk-Reversal:  <wie du das Risiko auf dich nimmst — haltbar>
- CTA:            <der eine kleine nächste Schritt>
- Preis-Anker:    <Preis + Modell, am Outcome verortet>
```
...
Bausteine: Outcome = 8–12 Termine/Monat · Proof = 3→11 in 60 Tagen (benannt im Call) · Risk-Reversal =
...
- **Proof erfinden** oder fremde Zahlen leihen — `ANNAHME(...)` ist ehrlich, eine erfundene Zahl ist Gift.
- **Risk-Reversal versprechen, die du nicht hältst** (Geld-zurück, das du nie zahlst) — zerstört Vertrauen.
...
- **Outcome > Feature, immer.** Der Kunde kauft, was er danach hat, nicht was du tust.
