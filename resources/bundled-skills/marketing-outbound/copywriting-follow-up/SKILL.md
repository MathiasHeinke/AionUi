...
description: "Nutze, wenn der erste Touch raus ist und keine Antwort kam — schreibt 2–5 Follow-ups, jedes mit einem ANDEREN Angle (neuer Wert, nicht „nachfassen"), plus einen sauberen Break-up. Beispiele: \"Schreib das Follow-up zu meiner ersten Mail\", \"3 Touches für den Kontakt, der nicht geantwortet hat\", \"Break-up-Mail für acme.com\", \"follow-up sequenz, je anderer angle\""
---
...
- **Nicht** nutzen, wenn ein „Nein" oder „kein Interesse" kam. Dann ist Schluss — weitermachen nach Nein
...
Funkstille. Bei kalten Email-Kontakten gilt: im Zweifel Touch 3 auf **LinkedIn oder Telefon** legen —
beide praktisch unkritisch. Das ist Orientierung, kein Gesetzes-Gate — du entscheidest und bleibst
verantwortlich.
...
- Optional: `outreach-brief.md` (zieht Value-Props, Trigger, Wettbewerb → liefert die Angles automatisch),
...
2. **Angles planen, bevor du textest.** Leg pro Touch _einen_ Angle fest, jeder eigenständig wertvoll.
   ...
   dann braucht es ein neues Signal, keine zweite Mail.
3. **Pro Touch: Wert zuerst, dann die Frage.** Satz 1 liefert den neuen Gedanken (nicht „ich melde mich
   nochmal"). Satz 2 = niedrigschwellige Ja/Nein-Frage. Kürzer als der erste Touch — jeder Folge-Touch
   schrumpft, nicht wächst.
4. **Timing setzen.** Default-Kadenz: Touch 1 → +3 Werktage → +4 → +5 → Break-up nach ~7. Nie zwei
   Touches am selben oder Folgetag. Frühmorgens/Abends-Versand wirkt menschlicher als 10:00 sharp.
5. **Kanal prüfen.** Kam per Email zweimal nichts: leg Touch 3 auf LinkedIn (`copywriting-linkedin-dm`)
   oder Telefon (`cold-call-script`) — anderer Kanal schlägt vierte Mail. Notier den Wechsel.
6. **Break-up bauen.** Letzter Touch: kein Vorwurf, kein Schuld-Trigger. „Ich nehme an, gerade kein
   Thema — ich halte mich zurück. Falls sich das ändert, weißt du, wo du mich findest." Ein ehrlicher
   Break-up holt erfahrungsgemäß die meisten Spät-Replies.
7. **Verbots-Check (hart).** Streiche jeden dieser Bausteine, ohne Ausnahme:
   - „ich wollte nur kurz nachfassen" / „nochmal melden" / „nachhaken"
   - „falls meine Mail untergegangen ist" / „nach oben holen" / „ganz oben in der Inbox"
...
- **Hilfreiche Ressource** → „unabhängig davon, ob wir reden: {1 konkreter Tipp / Checkliste}, kostet dich nichts."
- **Reframe** → „vielleicht ist {Problem} bei euch gar nicht {X}, sondern {Y} — dann wäre der Hebel ein anderer."
...
{Satz 2: niedrigschwellige Ja/Nein-Frage}

TOUCH 3 — +4 Werktage · Angle: {Mini-Case}  · ggf. Kanalwechsel LinkedIn/Telefon
{Satz 1: Proof/Case} {Satz 2: Frage}

BREAK-UP — +7 Werktage · Angle: sauberer Abschluss
{ein Satz Annahme + Tür offen, kein Vorwurf}
```
...
- Touches zu eng takten (täglich) oder zu viele (>4 + Break-up). Nach „Nein"/Break-up weiterschreiben.
...
- **Stopp ist Stopp.** Nach „Nein"/„kein Interesse" oder dem Break-up: Funkstille. Jeder Touch hat einen
  sauberen Opt-out.
- **Evidenz vor Behauptung.** Cases/Zahlen nur, wenn echt; sonst als `ANNAHME(... — zu verifizieren)`
  markieren, keine erfundenen Kunden.
...
- Falls Kanalwechsel sinnvoll: Hinweis + Verweis auf `copywriting-linkedin-dm` bzw. `cold-call-script`.
