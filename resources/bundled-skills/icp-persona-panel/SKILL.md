...
1. **DEFINE the thing under test + the ICP + the markets.** State flatly _what_ is being validated
   (paste the actual ad/headline/offer/price — never a paraphrase), _who_ the target group is, and _which
   markets_ (e.g. DE / AT / CH, or DE vs US). Pin the success bar: what would count as validated?
