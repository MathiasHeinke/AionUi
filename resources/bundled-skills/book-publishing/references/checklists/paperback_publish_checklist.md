...
- [ ] KI-Inhaltsinventur enthält Text, Übersetzung und Cover; **Mensch bestätigt Offenlegung**
- [ ] Keywords und Kategorien in der aktuell angebotenen Anzahl gepflegt
...
- [ ] Mensch hat `interior.pdf` nach Agent-Preflight hochgeladen
- [ ] Mensch hat `cover_wrap.pdf` hochgeladen (Cover-Template vorher gezogen)
...
- [ ] Print-Listenpreis exklusive lokaler USt. eingegeben; Kundenpreis-Vorschau geprüft
