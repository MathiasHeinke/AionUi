...
$rawEvidence = [ordered]@{
  ...
  runtime = [ordered]@{
    ...
    hermes_wheel_sha256 = [string](Get-OptionalProperty $runtimeHermes 'wheel_sha256' '')
    hermes_expected_wheel_sha256 = [string](Get-OptionalProperty $runtimeHermes 'wheel_expected_sha256' '')
    hermes_wheel_sha256_verified = [bool]((Get-OptionalProperty $runtimeHermes 'wheel_sha256_verified' $false) -eq $true)
